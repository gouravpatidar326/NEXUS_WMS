...
const INVENTORY_CLERK_PERMISSIONS = [
  ...
  PERMISSIONS.PO_EDIT,
  PERMISSIONS.PO_RECEIVE,
  PERMISSIONS.RECEIVING_EXECUTE,
  // Transfers — full access
  PERMISSIONS.TO_VIEW,
  PERMISSIONS.TO_CREATE,
  PERMISSIONS.TO_EDIT,
  PERMISSIONS.TO_EXECUTE,
  // Sales Orders — view only, no approve
  PERMISSIONS.SO_VIEW,
  PERMISSIONS.SO_PICK,
  // Picking — full access
  ...
  PERMISSIONS.SHIPPING_TRACK,
  PERMISSIONS.SHIPPING_EXECUTE,
  PERMISSIONS.SHIPPING_DELETE,
  // No FACILITIES_VIEW, CLIENTS_VIEW, USERS_VIEW, REPORTS_VIEW
];
